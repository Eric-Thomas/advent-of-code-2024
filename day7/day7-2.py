...
def dfs(i, test_value, operands, result):
    ...
    for operator in OPERATORS:
        ...
        if operator == "+":
            ...
            # this will combine operands as a string. Ex 124 || 38 -> 12438
        ...
        if operator == "+":
            ...
            # this will inverse the operator to combine operands as a string.
            # there's probably a more readable way to do this
            result = int(str(result)[: len(str(result)) - len(str(operands[i]))])
    return False
